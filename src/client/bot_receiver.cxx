...
bot_receiver::bot_receiver(tip::pipe::front&& bot_stdout, bot_processing_queue::producer& producer) :
...
{
    bot_processing_queue::producer::result result = bot_processing_queue::producer::result::success;
	...
	if (TURBO_UNLIKELY(result != bot_processing_queue::producer::result::success))
	{
